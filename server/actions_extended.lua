...
CreateThread(function()
    ...
    if not resolved then
        print('^3[LyxPanel]^7 actions_extended: ESX no disponible (timeout inicial). Reintentando cada 2s...')
        ...
        print('^2[LyxPanel]^7 actions_extended: ESX detectado tras reintento. Registrando callbacks.')
    end
